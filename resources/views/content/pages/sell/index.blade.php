...
@section('title', 'Sell  - Finance')

@section('content')
  <div class="card mb-6">
    <h5 class="card-header"> Sell </h5>
  ...
  <div id="itemRows">
    <div class="row g-3 mt-1 align-items-end item-row">
      ...
      <div class="col-md-1">
        ...
        <input type="text" name="size[]" class="form-control" placeholder="Width" />
      </div>
      <div class="col-md-1">
        <label class="form-label"></label>
        <input type="text" name="size[]" class="form-control" placeholder="Height" />
      </div>
      <div class="col-md-1">
      ...
      <div class="col-md-1">
        <label class="form-label"></label>
        <input type="number" name="sheets[]" class="form-control"  placeholder="Height " />
      </div>
      <div class="col-md-1">
   ...
   <hr />
    ...
    <div class="col-md-2">
      <label class="form-label">Recieved Amount</label>
    <input type="number" class="form-control" placeholder="123" />
    </div>
    <div class="col-md-2">
