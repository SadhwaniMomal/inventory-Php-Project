...
@section('content')
  ...
  <div class="card mb-6">
    <h5 class="card-header">journal Voucher </h5>
    ...
    <form class="card-body">
      ...
      <div class="row g-6">
        ...
        <div class="col-md-6">
          <label class="form-label" for="multicol-country">Dr Account Type</label>
        ...
        <div class="col-md-6">
          <label class="form-label" for="multicol-country">Dr Account </label>
          <select id="multicol-country" class="select2 form-select" data-allow-clear="true">
            <option value="">Select</option>
            <option value="Australia">Assets</option>
          </select>
        ...
        <div class="col-md-6">
          <label class="form-label" for="multicol-country">Cr Account Type</label>
          <select id="multicol-country" class="select2 form-select" data-allow-clear="true">
            <option value="">Select</option>
            <option value="Australia">Assets</option>
          </select>
        ...
        <div class="col-md-6">
          <label class="form-label" for="multicol-country">Cr Account </label>
          <select id="multicol-country" class="select2 form-select" data-allow-clear="true">
            <option value="">Select</option>
            <option value="Australia">Assets</option>
          </select>
